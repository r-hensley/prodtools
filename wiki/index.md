...
- [[2026-07-03-file-resolver-and-sam-query-plan]] — approved-not-started plan: one file-location resolver module (kills the 4 parallel inloc/path/token-scope mechanisms; jobfcl's raw `SAMWebClient` seam break) on top of a deepened `samweb_wrapper` owning all SAM access + query grammar (14 files compose dimension strings ad hoc today); MetaCat-migration seam _(proposed 2026-07-03)_
